                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-warning invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ allUser() }}</h2>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-success invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ verifiedUsers() }}</h2>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ rejectedUsers() }}</h2>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ pendingUsers() }}</h2>
                                ...
                                <div class="card-body d-flex">
                                    <div class="me-auto">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <h2 class="fs-38 mb-0">{{ userWidthrawalBalance() }}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h2 class="fs-38">{{ userPendingBalance() }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mt-3 mb-2">
                                        <h2 class="fs-38 mb-0 me-3">{{ userApprovedBalance() }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mt-3 mb-2">
                                        <h2 class="fs-38 mb-0 me-3">{{ todayApprovedWidthraw() }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
